...
This is a weather web application powered by React.js that shows real-time weather data using OpenWeather API.<br/>
You can check out the [Demo](https://reactweatherr-app.netlify.app).
<br/><br/>
...
## Features 🆕
- Realtime updates of weather around the world. Thanks to OpenWeather API 🌐
